return {
	...
	config = function()
		...
		vim.keymap.set("n", "<leader>uk", function()
			cmp_enable = not cmp_enable

			local status = cmp_enable and "aktiviert" or "deaktiviert"
			vim.notify("Completion: " .. status, vim.log.levels.INFO, { title = "nvim-cmp" })
